...
export declare function getAscToJsConverterForType(
  typeName: string
): (asbindInstance: AsbindInstance, value: any, typeName: string) => any;
export declare function getJsToAscConverterForType(
  typeName: string
): (asbindInstance: AsbindInstance, value: any, typeName: string) => any;
